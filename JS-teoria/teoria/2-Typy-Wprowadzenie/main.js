...
// Number - liczba (bez podziału na integer(liczba całkowita), float, decimal - czyli bez podziału na liczbę całkowitą czy ułamek dziesiętny jak to jest w wielu innych językach programwania. )
typeof 222.222;
typeof 1000;
typeof 3.2e10;
typeof NaN;
typeof (2.2 * "a"); //konwersja niejawna "a" na liczbę daje NaN, a 2.2 * NaN daje też NaN (Not a Number)
...
let primitiveType2 = primitiveType1; //Tworzona jest kopia, wartość identyczna, ale nie ta sama (jest to idealna kopia wartości, ale stanowiaca już osobną wartość)
...
// Ponieważ wartość została skopiowana i obie zmienne mają rózne wartości, to przypsiania nowej wartości do zmiennej primitiveType1 nie wpływa na zmienną primitiveType2. Nie ma miedzy nimi żadnego połączenia.
