...
// - można z dużej litery zacząć i używać ich w nazwie (wielkość liter znaczenie), można używać podkreślenia (_) i znaku $
...
// Różnice
//  - "let" i "const" można zadeklarować tylko raz, var (co jest głupie) pozwala deklarować wielokrotnie
//  - do "const" nie mozna przypisać nowej wartości (można modyfikować obiekty, które są przypisane)

let example1 = 200;
example1=example+1; // przypisujemy nową wartość zwiększoną o 1
example1--; //przypisujemy nową wartość zmniejszoną o1
const example2 = 200;
