...
const lengthArrayAfterPush = italianUsers.push("Vito"); //metoda zwraca długość tablicy jaką ma tablica po jej wykonaniu
const lengthArrayAfterUnshift = italianUsers.unshift("Apollonia"); //też zwraca długość po dodaniu
